...
def set_formats(wb: Workbook) -> dict:
    return {
        ...
        'data_header': wb.add_format({**P_FMT.BOLD_FONT, **P_FMT.CENTER_ALIGN, **P_FMT.TEXT_WRAP, **P_FMT.GREY_BG}),
        'data_header_bottom': wb.add_format(
            {**P_FMT.BOLD_FONT, **P_FMT.CENTER_ALIGN, **P_FMT.TEXT_WRAP, **P_FMT.GREY_BG, **P_FMT.THICK_BOTTOM_BORDER}
        ),
        ...
        'data_row_bold': wb.add_format({**P_FMT.BOLD_FONT, **P_FMT.CENTER_ALIGN, **P_FMT.TEXT_WRAP, **P_FMT.THIN_BOTTOM_BORDER}),
        'data_row_center': wb.add_format({**P_FMT.TEXT_WRAP, **P_FMT.DEFAULT_FONT, **P_FMT.CENTER_ALIGN, **P_FMT.THIN_BOTTOM_BORDER}),
