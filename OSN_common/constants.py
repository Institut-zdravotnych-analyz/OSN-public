    ...
    P2 = {
        ...
        "vysvetlivky": [
            ...
            },
            {
                "title": "",
                "rows": [
                    "NOV - Označenie pre spôsob určenia medicínskej služby, ak mal poistenec vykázaný druh prijatia do ÚZZ s hodnotou 3 - 6 a skupiny klasifikačného systému, do ktorej bol hospitalizačný prípad zaradený alebo druh prijatia do ÚZZ s hodnotou 3 - 6 a podľa skupiny klasifikačného systému a zdravotného výkonu alebo diagnózy podľa doplňujúceho kritéria podľa prílohy č. 5.",
                    ...
                    "MV - Označenie pre spôsob určenia medicínskej služby, ak bol poistencovi počas hospitalizácie poskytnutý v kombinácii marker s hodnotou markera a jeden alebo viac zdravotných výkonov zo zoznamu ďalších zdravotných výkonov podľa prílohy č. 7a alebo č. 8a, sa medicínska služba určí podľa kombinácie markera s hodnotou markera a vykázaného zdravotného výkonu alebo podľa markera s hodnotou markera a vykázaných zdravotných výkonov podľa prílohy č. 7a alebo č. 8a.",
                    ...
                    "MD - Označenie pre spôsob určenia medicínskej služby, ak bol poistencovi počas hospitalizácie vykázaný marker s hodnotou markera pri vykázanej diagnóze, ktorý zodpovedá kombinácii markera s hodnotou markera a diagnózy podľa prílohy 9a, medicínska služba sa určí podľa kombinácie markera s hodnotou markera a diagnózy podľa prílohy č. 9a.",
